...
class DirectoryServicesImplTest {
    ...
    companion object {
                        ...
                        PackageMetadataEntry.newBuilder()
                            ...
                            .setPackageMetadata(
                                javaClass.classLoader
                                    .getResourceAsStream("accrescent-0.25.0-package-metadata.txtpb")
                                    ?.use {
                                        val builder = PackageMetadata.newBuilder()
        ...
        // country_set.
        private val validDeviceAttributes = DeviceAttributes.newBuilder()
            .setSpec(
